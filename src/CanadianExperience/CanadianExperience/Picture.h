...
public:
    ...
    */
	...
	/// for TEXT BUBBLE animation
	void OnRButtonDown(CPoint pos);

	// ----------------------------------------- OPERATION SNOW ----------------------------//

	//owns a SnowflakeSystem!!!!!
	//void SetSnowflakeSystem(std::shared_ptr<CSnowflakeSystem> system){ mSnowflakeSystem = system; }
...
private:
	...
	CSnowflakeSystem mSnowflakeSystem;   ///< The Snowflake System
};
