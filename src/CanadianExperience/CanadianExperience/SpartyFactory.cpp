...
std::shared_ptr<CActor> CSpartyFactory::Create()
{
	...
	auto flag = make_shared<CImageDrawable>(L"MSU flag", L"images/msu_flag.png");
	flag->SetCenter(Point(89, 26));
	flag->SetPosition(Point(20 - 110, 22 - 180));
	rarm->AddChild(flag);
	...
	std::shared_ptr<CTextBubbleDrawable> textBubble = make_shared<CTextBubbleDrawable>();
	textBubble->SetPosition(Point(100, -90));
	headb->AddChild(textBubble);
