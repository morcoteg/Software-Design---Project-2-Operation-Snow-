...
BEGIN_MESSAGE_MAP(CViewTimeline, CScrollView)
	...
	ON_COMMAND(ID_FILE_PLAY, &CViewTimeline::OnFilePlay)
	ON_COMMAND(ID_FILE_PLAYFROMBEGINNING, &CViewTimeline::OnFilePlayfrombeginning)
	ON_COMMAND(ID_FILE_STOP, &CViewTimeline::OnFileStop)
	ON_WM_TIMER()
END_MESSAGE_MAP()
 ...
 */
 ...
 /////////////////////////////// PLAY, PLAY FROM BEGINNING, STOP /////////////////////////////////////



 void CViewTimeline::OnFilePlay()
 {
	 // it's now playing!
	 mIsPlaying = true;
	 ...
	 */
	 ...
	 if (mIsPlaying)
	 {
		 SetTimer(mElapsed, FrameDuration, nullptr);
	 }
 }


 void CViewTimeline::OnFilePlayfrombeginning()
 {
 ...
 {
	 // runs the timer ONLY if we are playing the program!
	 if (mIsPlaying)
	 {
		 /*
		 ...
		 */
		 ...
		 GetPicture()->SetAnimationTime(mElapsed);
